...
module.exports = (crypto, EventEmitter, fs, timers) => {
    ...
    class DdqBackendMock extends EventEmitter {
        ...
        /**
         * Mock of startListening. It just simply calls the callback.
         * There is a helper function checkAndEmitData that can be called to
         * simulate data being emitted while polling.
         *
         * @param {Function} callback
         */
        startListening(callback) {
            // Just calling the callback if one is pass
            if (callback) {
                callback();
            }
        }
